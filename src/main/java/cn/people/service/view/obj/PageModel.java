...
//        }
    ...
    public static void main(String[] args) {
    	...
    	list.add(4);
    	int pageRecorders = 3;
    	PageModel page = new PageModel(list, pageRecorders);
    	List sublist = page.getPageList(2);//显示第几页 
    	
//    	for(int i=0;i<sublist.size();i++){
//    		System.out.println(sublist.get(i));
//    	}
//    	System.out.println("_itemStart"+(page.getPageStartRow()+1));
//    	
//    	System.out.println("_itemEnd"+page.getPageEndRow());
//    	
//    	System.out.println("_itemTotal"+page.getTotalRows());
